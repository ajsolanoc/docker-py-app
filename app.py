...
def hello():
    ...
    #return html.format(name=os.getenv("NAME", "CondorLabs"), hostname=socket.gethostname(), visits=visits, ip=subprocess.check_output(['bash', '-c', "/sbin/ip route|awk '/default/ { print $3 }'"]).decode('utf-8').strip())
